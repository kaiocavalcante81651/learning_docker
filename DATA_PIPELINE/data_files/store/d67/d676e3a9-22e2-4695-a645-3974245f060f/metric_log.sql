ATTACH TABLE _ UUID '78fc908f-4dcf-4c7b-a077-05038109dedf'
(
    ...
    `ProfileEvent_RemoteReadThrottlerBytes` UInt64 COMMENT 'Bytes passed through \'max_remote_read_network_bandwidth_for_server\' throttler.',
    `ProfileEvent_RemoteReadThrottlerSleepMicroseconds` UInt64 COMMENT 'Total time a query was sleeping to conform \'max_remote_read_network_bandwidth_for_server\' throttling.',
    `ProfileEvent_RemoteWriteThrottlerBytes` UInt64 COMMENT 'Bytes passed through \'max_remote_write_network_bandwidth_for_server\' throttler.',
    `ProfileEvent_RemoteWriteThrottlerSleepMicroseconds` UInt64 COMMENT 'Total time a query was sleeping to conform \'max_remote_write_network_bandwidth_for_server\' throttling.',
    `ProfileEvent_LocalReadThrottlerBytes` UInt64 COMMENT 'Bytes passed through \'max_local_read_bandwidth_for_server\' throttler.',
    `ProfileEvent_LocalReadThrottlerSleepMicroseconds` UInt64 COMMENT 'Total time a query was sleeping to conform \'max_local_read_bandwidth_for_server\' throttling.',
    `ProfileEvent_LocalWriteThrottlerBytes` UInt64 COMMENT 'Bytes passed through \'max_local_write_bandwidth_for_server\' throttler.',
    `ProfileEvent_LocalWriteThrottlerSleepMicroseconds` UInt64 COMMENT 'Total time a query was sleeping to conform \'max_local_write_bandwidth_for_server\' throttling.',
